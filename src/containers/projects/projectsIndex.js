export const myProjects = [
  ...
  },
  {
    name: 'Battleships',
    gif:
      'https://res.cloudinary.com/kikupiku/image/upload/v1597065128/project-gifs/battleships_udxrye.gif',
    github: 'https://github.com/kikupiku/battleships',
    link: 'https://kikupiku.github.io/battleships/',
  },
  {
    name: 'Weather App',
    gif:
  ...
  },
  {
    name: 'Odinbook',
    gif:
      'https://res.cloudinary.com/kikupiku/image/upload/v1597065129/project-gifs/odinbook_coepbo.gif',
    github: 'https://github.com/kikupiku/fakebook',
    link: 'https://odinbook-kikupiku.herokuapp.com/',
  },
  {
    name: 'Pomodoro Timer',
    gif:
